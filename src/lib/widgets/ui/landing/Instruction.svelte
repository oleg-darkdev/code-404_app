<div class="cart-modal">
      <div scroll="enable" data-w-id="255d5b0b-33cf-f30e-7ac5-00733b1141dc" class="cart-blend"></div>
      <div id="cart-modal" class="cart-wrapper">
        <div class="cart-inner-wrapper">
          <div class="big-heading has__all-caps cc-cart-heading">Warenkorb</div>
          <div id="cart-item-wrapper" class="cart-item-wrapper">
            <div id="cart-empty-wrapper" class="cart-empty-wrapper">
              <div class="cart-empty-text">Dein Korb ist leer. Wie wärs denn hiermit? :)</div>
              <div class="cart-suggestion-wrapper w-dyn-list">
                <div role="list" class="cart-suggestion-list w-dyn-items">
                  <div role="listitem" class="cart-suggestion-item w-dyn-item">
                    <a href="/" class="link-block-product cc-cart-suggestion w-inline-block">
                      <div class="product-meta-wrapper">
                        <div class="product-heading-wrapper">
                          <h3 class="cart-item-overview-heading">DECAF - ent­koffe­inier­ter Kaffee</h3>
                        ...
                        <div class="product-overview-price-wrapper">
                          <div class="product-overview-price-holder main-price">
                            <div price="DECAF - ent­koffe­inier­ter Kaffee" class="product-overview-price">10.00</div>
                            <div class="product-overview-price">€</div>
                          </div>
                          <div class="product-overview-price-holder sold-out w-condition-invisible">
                            <div fs-cmssort-field="price" class="product-overview-price">sold out</div>
                          </div>
                          <div class="product-overview-price-holder off-price w-condition-invisible">
                            <div price="DECAF - ent­koffe­inier­ter Kaffee" class="product-overview-price off-price w-dyn-bind-empty"></div>
                            <div class="product-overview-price">€</div>
                          </div>
                        </div>
                      </div>
                      <div class="product-thumbnail-wrapper">
                        <img src="/images/65d4dbabb8725cba75e1bd79_DECAF_-_KROM_Kaffeerosterei_Magdeburg.jpeg" loading="lazy" alt="DECAF - ent­koffe­inier­ter Kaffee" sizes="100vw" srcset="/images/65d4dbabb8725cba75e1bd79_DECAF_-_KROM_Kaffeerosterei_Magdeburg-p-500.jpeg 500w, /images/65d4dbabb8725cba75e1bd79_DECAF_-_KROM_Kaffeerosterei_Magdeburg-p-800.jpeg 800w, /images/65d4dbabb8725cba75e1bd79_DECAF_-_KROM_Kaffeerosterei_Magdeburg-p-1080.jpeg 1080w, /images/65d4dbabb8725cba75e1bd79_DECAF_-_KROM_Kaffeerosterei_Magdeburg.jpeg 1200w" class="product-image cc-landingpage">
                      </div>
                    </a>
                  </div>
                  <div role="listitem" class="cart-suggestion-item w-dyn-item">
                    <a href="/" class="link-block-product cc-cart-suggestion w-inline-block">
                      <div class="product-meta-wrapper">
                        <div class="product-heading-wrapper">
                          <h3 class="cart-item-overview-heading">ACHTZIG ZWANZIG dark roast</h3>
                          <div class="organic-logo w-condition-invisible">
                            <img src="/images/613c8a9ba868284649a34016_EU-Organic-Logo.svg" loading="lazy" alt="EU-Bio-Logo. Vorverpackte Bio-Lebensmittel, aus der EU, welche die strengen Normen der EU-Rechtsvorschriften für den ökologischen Landbau erfüllen, müssen seit dem 1. Juli 2010 verpflichtend mit dem EU-Bio-Logo gekennzeichnet werden." class="organic-logo-eu">
                          </div>
                        </div>
                        <div class="product-overview-price-wrapper">
                          <div class="product-overview-price-holder main-price">
                            <div price="ACHTZIG ZWANZIG dark roast" class="product-overview-price">10.00</div>
                            <div class="product-overview-price">€</div>
                          </div>
                          <div class="product-overview-price-holder sold-out w-condition-invisible">
                            <div fs-cmssort-field="price" class="product-overview-price">sold out</div>
                          ...
                          <div class="product-overview-price-holder off-price w-condition-invisible">
                            <div price="ACHTZIG ZWANZIG dark roast" class="product-overview-price off-price w-dyn-bind-empty"></div>
                            <div class="product-overview-price">€</div>
                          </div>
                        </div>
                      </div>
                      <div class="product-thumbnail-wrapper">
                        <img src="/images/641329557df473d965c591d8_AchtzigZwanzig-KROeMKaffeeroestereiMagdeburg_67eecd8d-a7a7-4b9d-a40e-074287d41ea9.jpeg" loading="lazy" alt="ACHTZIG ZWANZIG dark roast" sizes="100vw" srcset="/images/641329557df473d965c591d8_AchtzigZwanzig-KROeMKaffeeroestereiMagdeburg_67eecd8d-a7a7-4b9d-a40e-074287d41ea9-p-500.jpeg 500w, /images/641329557df473d965c591d8_AchtzigZwanzig-KROeMKaffeeroestereiMagdeburg_67eecd8d-a7a7-4b9d-a40e-074287d41ea9-p-800.jpeg 800w, /images/641329557df473d965c591d8_AchtzigZwanzig-KROeMKaffeeroestereiMagdeburg_67eecd8d-a7a7-4b9d-a40e-074287d41ea9-p-1080.jpeg 1080w, /images/641329557df473d965c591d8_AchtzigZwanzig-KROeMKaffeeroestereiMagdeburg_67eecd8d-a7a7-4b9d-a40e-074287d41ea9.jpeg 1200w" class="product-image cc-landingpage">
                      </div>
                    </a>
                  </div>
                </div>
            ...
            <div id="cart-item-loading-spinner" class="cart-item-loading-spinner">
              <div class="loading-spinner" data-w-id="7530af3d-e416-203f-25d3-3207bbc9251b" data-animation-type="lottie" data-src="https:/cdn.prod.website-files.com/610cf33140aaf753c6f8f7bb/62695a031f1563936b525a72_lf30_editor_3sebc4ky.json" data-loop="1" data-direction="1" data-autoplay="1" data-is-ix2-target="0" data-renderer="svg" data-default-duration="3.16" data-duration="0"></div>
            </div>
          </div>
          <div class="cart-summary-wrapper">
            <div class="cart-price-wrapper">
              <div class="cart-price">Zwischensumme:</div>
              <div id="cart-price" class="cart-price">00,00€</div>
            </div>
            <div class="checkout-info">Versand und Rabattcodes werden beim Checkout hinzugefügt.</div>
            <div id="cart-checkout-button" class="std-button is__black is__bigger is__100 is__not-active">Zur Kasse</div>
          </div>
          <div scroll="enable" data-w-id="255d5b0b-33cf-f30e-7ac5-00733b1141e8" class="close-cart-modal-button">
            <div class="x-stroke rotated"></div>
            <div class="x-stroke"></div>
          </div>
          <div id="cart-preloader" class="cart-preloader">
            <div class="div-block-32">
              <div data-w-id="d3da09da-f961-afd7-dc20-602f410e8f5d" data-animation-type="lottie" data-src="https:/cdn.prod.website-files.com/610cf33140aaf753c6f8f7bb/61965ab806482f517e990003_herdkanne%20-%20login.json" data-loop="1" data-direction="1" data-autoplay="1" data-is-ix2-target="0" data-renderer="svg" data-default-duration="5.005004801146985" data-duration="0"></div>
              <div class="normal-text is__bold">Gleich gehts weiter zur Kasse</div>
            </div>
          </div>
          <div class="cart-maintence-block">
            <div class="margin-bottom margin-small">
              <div class="semi-heading">Wir sind gleich zurück 🚧</div>
            </div>
            <div class="normal-text">Hey du! Sorry! Aktuell führen wir Wartungsarbeiten an der Seite durch. Schau bitte später nochmal vorbei wenn wir durch sind :-). Vielen Dank für dein Verständnis! KRÖM</div>
          </div>
        </div>
      </div>
      <div class="cart-background"></div>
    </div>
    <div class="section has__violet-gradient">
      <div class="padding-top padding-custom1">
        <div class="container has__bottom-sep-line">
          <div class="page-heading-wrapper has__text-inside _64px-grid standard-heading-wrapper">
            <div id="w-node-_771bbc5a-d711-8350-278d-13356ffc2a7f-a3ee7913" class="headline-wrapper">
              <h1 class="big-heading">Datenschutz</h1>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="section">
      <div class="container">
        <div class="padding-vertical padding-huge">
          <div class="layout-impressum">
            <div class="lega-rich-text w-richtext">
              ...
              <h2>2. Hosting</h2>
              <h3>Webflow</h3>
              <p>Wir hosten unsere Website bei Webflow. Anbieter ist die Webflow, Inc., 398 11th Street, 2nd Floor, San Francisco, CA 94103, USA (nachfolgend Webflow). Wenn Sie unsere Website besuchen, erfasst Webflow verschiedene Logfiles inklusive Ihrer IP-Adressen.</p>
              ...
              <p>Details entnehmen Sie der Datenschutzerklärung von Webflow: <a href="/" target="_blank">https:/webflow.com/legal/eu-privacy-policy</a>. </p>
              ...
              <p>Die Datenübertragung in die USA wird auf die Standardvertragsklauseln der EU-Kommission gestützt. Details finden Sie hier: <a href="/" target="_blank">https:/webflow.com/legal/eu-privacy-policy</a>. </p>
              ...
              <p>Julian König <br>Alt Westerhüsen 41 <br>39112 Magdeburg <br>E-Mail: info@kaffeerösterei-magdeburg.de </p>
              ...
              <p>Julian König <br>KRÖM Kaffeerösterei Magdeburg <br>Alt Westerhüsen 41 <br>39122 Magdeburg <br>E-Mail: info@kaffeeroesterei-magdeburg.de </p>
              ...
              <p>
                ...
                <a href="/" target="_blank">
                  <em>Google Ireland Limited</em>
                </a>
                <em></em>– Webanalyse <br>Auf Grundlage Ihrer Einwilligung gemäß Art. 6 Abs. 1 lit. a DS-GVO setzen wir unter Verwendung des Google Tag Managers Google Analytics, einen Webanalysedienst der Google Ireland Limited („Google“) ein. Hierzu wurde mit Google ein Vertrag zur Auftragsverarbeitung gemäß Art. 28 DS-GVO geschlossen. Darüber hinaus bestehen im Falle einer Daten-übermittlung an die Konzernmutter Google LLC – mit Sitz in den USA – durch den Abschluss von Standarddatenschutzklauseln gemäß Art. 46 Abs. 2 lit. c DS-GVO geeignete Garantien für den Schutz betroffener Personen i.S.d. Art. 46 Abs. 1 DS-GVO. Ihre Einwilligungserklärung umfasst ausdrücklich auch die mögliche weltweite Datenübermittlung und -verarbeitung durch weitere Konzernunternehmen der Google LLC. Wir möchten diesbezüglich ausdrücklich auf etwaige Risiken hinweisen, beispielsweise der erschwerten Durchsetzung datenschutzrechtlicher Betroffenenrechte. <br>
                <br>Durch die von Google Analytics gesetzten Cookies werden Nutzungsdaten (z.B. besuchte Internetseiten, Zugriffszeiten) sowie Kommunikationsdaten (z.B. IP-Adressen, Geräteinformationen) in unserem Auftrag verarbeitet, um die Nutzung unseres Online-Angebots auszuwerten, Reports über die Aktivitäten innerhalb unseres Online-Angebots zusammenzustellen sowie weitere, mit der Nutzung unseres Online-Angebots verbundene Dienstleistungen zu erbringen. Hierbei ist auch eine Erstellung von pseudonymisierten Nutzerprofilen möglich. <br>
                <br>Der Einsatz von Google Analytics erfolgt ausschließlich mittels IP-Anonymisierung. Sämtliche verarbeiteten personenbezogene Daten werden nach 14 Monaten gelöscht oder vollständig anonymisiert. Weitere Informationen zur Datennutzung durch Google, Einstellungs- und Widerspruchsmöglichkeiten, erfahren Sie in der <a href="https:/policies.google.com/" target="_blank">Datenschutzerklärung von Google </a>sowie in den <a href="https:/adssettings.google.com/authenticated?hl=de" target="_blank">Einstellungen für die Darstellung von Werbeeinblendungen</a> durch Google.
              </p>
              ...
              <p>Eine Übersicht über die Facebook Social-Media-Elemente finden Sie hier: <a href="https:/developers.facebook.com/docs/plugins/?locale=de_DE" target="_blank">https:/developers.facebook.com/docs/plugins/?locale=de_DE</a>. </p>
              ...
              <p>Mailchimp mit deaktivierter Erfolgsmessung</p>
              ...
              <p>Wenn Sie nicht möchten, dass Ihre Daten an Mailchimp übertragen werden, müssen Sie den Newsletter abbestellen. Hierfür stellen wir in jeder Newsletternachricht einen entsprechenden Link zur Verfügung.</p>
              ...
              <h4>PayPal</h4>
              <p>Anbieter dieses Zahlungsdienstes ist PayPal (Europe) S.�&nbsp;.r.l. et Cie, S.C.A., 22-24 Boulevard Royal, L-2449 Luxembourg (im Folgenden „PayPal“).</p>
              <p>Die Datenübertragung in die USA wird auf die Standardvertragsklauseln der EU-Kommission gestützt. Details finden Sie hier: <a href="https:/www.paypal.com/de/webapps/mpp/ua/pocpsa-full" target="_blank">https:/www.paypal.com/de/webapps/mpp/ua/pocpsa-full</a>. </p>
              <p>Details entnehmen Sie der Datenschutzerklärung von PayPal: <a href="https:/www.paypal.com/de/webapps/mpp/ua/privacy-full" target="_blank">https:/www.paypal.com/de/webapps/mpp/ua/privacy-full</a>. </p>
              <h4>Apple Pay</h4>
              <p>Anbieter des Zahlungsdienstes ist Apple Inc., Infinite Loop, Cupertino, CA 95014, USA. Die Datenschutzerklärung von Apple finden Sie unter: <a href="https:/www.apple.com/legal/privacy/de-ww/" target="_blank">https:/www.apple.com/legal/privacy/de-ww/</a>. </p>
              <h4>Google Pay</h4>
              <p>Anbieter ist Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland. Die Datenschutzerklärung von Google finden Sie hier: <a href="https:/policies.google.com/privacy" target="_blank">https:/policies.google.com/privacy</a>. </p>
              <h4>Klarna</h4>
              ...
              <p>Details entnehmen Sie der Datenschutzerklärung von giropay: <a href="https:/www.paydirekt.de/agb/index.html" target="_blank">https:/www.paydirekt.de/agb/index.html</a>. </p>
              ...
              <p>Details entnehmen Sie der Datenschutzerklärung von Shopify Payment: <a href="https:/www.shopify.de/legal/" target="_blank">https:/www.shopify.de/legal/</a>. </p>
              <h4>Mastercard</h4>
              ...
              <p>VISA kann Daten an seine Muttergesellschaft in die USA übertragen. Die Datenübertragung in die USA wird auf die Standardvertragsklauseln der EU-Kommission gestützt. Details finden Sie hier: <a href="https:/www.visa.de/nutzungsbedingungen/visa-globale-datenschutzmitteilung/mitteilung-zu-zustandigkeitsfragen-fur-den-ewr.html" target="_blank">https:/www.visa.de/nutzungsbedingungen/visa-globale-datenschutzmitteilung/mitteilung-zu-zustandigkeitsfragen-fur-den-ewr.html</a>. </p>
              <p>Weitere Informationen entnehmen Sie der Datenschutzerklärung von VISA: <a href="https:/www.visa.de/nutzungsbedingungen/visa-privacy-center.html" target="_blank">https:/www.visa.de/nutzungsbedingungen/visa-privacy-center.html</a>. <br>
              </p>
            </div>
          </div>
        </div>
